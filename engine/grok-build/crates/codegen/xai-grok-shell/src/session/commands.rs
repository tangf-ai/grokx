...
pub enum SessionCommand {
    ...
    /// tool-free model call, and returns the response text plus optional
    /// thinking/reasoning for desktop side-chat UI.
    SideQuestion {
        question: String,
        /// `(answer, optional_thinking)` — thinking is model reasoning text when present.
        respond_to: oneshot::Sender<Result<(String, Option<String>), SideQuestionError>>,
    },
